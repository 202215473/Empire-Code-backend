...
from auctions.views import UserAuctionListView, UserBidListView, UserCommentListView, UserRatingListView
...
urlpatterns = [ 
    ...
    path('my-comments/', UserCommentListView.as_view(), name='user-comments'),  # protegido con permisos
    path('my-ratings/', UserRatingListView.as_view(), name='user-ratings'),  # protegido con permisos
]