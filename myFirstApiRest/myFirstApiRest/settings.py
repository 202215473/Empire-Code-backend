...
SECRET_KEY = 'django-insecure-2f7u)be-qwhok%0pc1)misghllj_bj-&=@y($zazur2krmk8tc'
...
REST_FRAMEWORK = { 
    ...
    'PAGE_SIZE': 6,  # Número de elementos que aparecen en la web
